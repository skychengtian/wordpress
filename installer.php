...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210317_e689bfe5a4a9e5b08fe7ab99_d42ddfa620d019709914_20210317224301_archive.zip';
	const ARCHIVE_SIZE		 = '28404432';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd42ddfa-17224301';
    const SECONDARY_PACKAGE_HASH = '605995a-17224301';
	const VERSION			 = '1.4.0';
